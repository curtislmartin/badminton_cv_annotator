...
WP7-65 | C | src/courtkeynet/validation_scripts/annotate_court_corners_offframe.py:main | LIVE TOOL: the data README and manual-labelling documentation identify this as the canonical off-frame annotator. | evidence: data/amateur_court_corners/README.md:3-6, docs/scraper_pipeline/broadcast_nonstandard_camera_id/broadcast_timeline_labelling_20260731-095201.md:311-313; src/courtkeynet/validation_scripts/annotate.sh:71-76; roots: audit_plan.md:25-36 | leave as canonical annotation tooling | confidence high
