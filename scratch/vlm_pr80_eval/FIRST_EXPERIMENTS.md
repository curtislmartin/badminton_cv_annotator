# First VLM cleanup experiments

> This is the preserved overview of the initial PR 80 investigation. See
> [README.md](README.md) for the complete record, including the six later
...
![Bar chart showing what the best scene check actually did](figures/scene_best_result_first_experiments.png)
...
At the time this investigation closed, its planned next step was a new contact detector. That is **historical context**, not the current plan. The completed follow-up sequence is indexed in [`FOLLOWUPS.md`](FOLLOWUPS.md).
...
- [`RESULTS_FIRST_EXPERIMENTS.md`](RESULTS_FIRST_EXPERIMENTS.md) — headline numbers, denominators, and limits
...
- [`FOLLOWUPS.md`](FOLLOWUPS.md) — completed follow-up sequence and supporting records
